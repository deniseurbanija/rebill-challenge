  ...
  return (
    <AnimatePresence>
      {showAddressSelector && (
        ...
        >
          <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-xl w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-sm font-medium text-[#3B4049]">
                  Select a saved address
                </h2>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500">
                    {addresses.length}{" "}
                    {addresses.length === 1 ? "result" : "results"}
                  </span>
                  <Button
                    variant="ghost"
                    size="icon"
              ...
              <div className="space-y-2 max-h-[50vh] overflow-y-auto">
                {addresses.map((address) => {
                  ...
                  return (
                    <motion.div
                      // this is not a good practise, i do it this way since placeId is not showing
                      key={address.street}
